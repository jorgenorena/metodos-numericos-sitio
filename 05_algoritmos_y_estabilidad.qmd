...
Vemos que son dos cantidades cercanas. Restarlas tiene un mal número de condicionamiento y se pierden cifras decimales de precisión. La formulita es inestable.
...
Tareas:
- Implemente el método babilónico partiendo desde $x_0 = 1.5$ y guarde la aproximación en cada iteración.
- Calcule el error absoluto $|x_k − \sqrt{2}|$ y grafíquelo en una escala apropiada.
- Estime el orden de convergencia p de cada método a partir de los errores (use las últimas iteraciones).
