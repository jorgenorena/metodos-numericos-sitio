...
Considere $\alpha = 0.1$ y los siguientes valores de $\beta = 10, 100, 10^3, ..., 10^12$. Produzca una tabla con las columnas $\beta$, $(x_1 - 1)$ y $\kappa(A)$. Explique.

## Tarea 5.9

Demuestre que si factorizamos una matriz de la forma $A = LU$, su determinante se puede escribir $\det(A) = \det(U) = \prod_i U_{ii}$. Escriba una función que use este hecho para calcular el determinante y verifique para tres matrices distintas.
