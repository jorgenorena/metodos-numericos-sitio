...
$$
\kappa_p(a) = \left |\frac{a \frac{dr_1}{da}}{r_1}\right| = \left|\frac{a r_1}{2a r_1 + b}\right| = \left|\frac{a r_1}{r_1 - r_2} \right|\,,
$$
...
Como ejemplo, busquemos las raices de $\frac{1}{3}(x - 1)(x - 1 - e)$ para $e$ pequeño. Si tomamos $e = 1e-6$ esperamos un número de condicionamiento $e$ y perdemos $6$ cifras de precisión.
